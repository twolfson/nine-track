  ...
  forwardRequest: function (localReq, callback) {
    ...
    async.waterfall([
      ...
      function createRemoteReq (connInfo, cb) {
        ...
        // TODO: If we are inside of a series and this is not a new recording
          // TODO: Clean up all past fixtures in this chain
          // TODO: Callback with an error complaining that the code has been altered, we have wiped the fixtures,
          //   and we will need a re-run of the test to get accurate data
