...
NineTrack.prototype = {
  getConnectionKey: function (conn) {
    ...
    // Add on past keys to our request
    // TODO: Note that this will break past fixtures as it always gets past keys to affect the SHA
    conn.request.headers['X-Nine-Track-Past-Keys'] = this.pastKeys.join(';');
